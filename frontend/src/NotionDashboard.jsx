...
const NotionDashboard = () => {
  ...
  return (
    <div className="animate-in fade-in duration-700">
      <header className="max-w-full mx-auto mb-8 animate-in fade-in slide-in-from-top-4 duration-700">
          ...
          <div className="flex items-center gap-6">
            <div>
              ...
              <p className="text-notion-text-secondary font-medium uppercase text-[10px] tracking-[0.3em] flex items-center gap-2">
                {user?.external_client_id} • Portal de Seguimiento
              </p>
            </div>
          </div>
                                      ...
                                      <button
                                        onClick={async (e) => {
                                          ...
                                          try {
                                            ...
                                            console.error(
                                              'Failed to mark as read on navigation:',
                                              err
                                            );
                                          }
      ...
      <main className="max-w-full mx-auto space-y-12 pb-16 animate-in fade-in duration-700 delay-200">
        {activeTab === TABS.PROJECTS && (
          <ProjectsListView grouped={grouped} onSelectProject={setSelectedProject} t={t} />
        )}
