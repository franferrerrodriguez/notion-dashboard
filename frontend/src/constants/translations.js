export const translations = {
  es: {
    ...
    refresh: 'Refrescar',
    search_placeholder: 'Buscar por nombre o directorio...',
    no_files: 'No hay ficheros',
    loading_docs: 'Cargando tus documentos',
    back: 'Volver',
    view: 'Ver',
    download: 'Descargar',
  ...
  en: {
    ...
    refresh: 'Refresh',
    search_placeholder: 'Search by name or directory...',
    no_files: 'No files found',
    loading_docs: 'Loading your documents',
    back: 'Back',
    view: 'View',
    download: 'Download',
